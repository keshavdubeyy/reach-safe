...
export default function EditContactScreen() {
  ...
  const [permissionLevel, setPermissionLevel] = useState<PermissionLevel>(contact?.permissionLevel || 'sos_only');
  const [receivesSOS, setReceivesSOS] = useState(contact?.receivesSOS ?? true);
  const [receivesCommuteUpdates, setReceivesCommuteUpdates] = useState(contact?.receivesCommuteUpdates ?? false);
  const [priority, setPriority] = useState<'primary' | 'secondary'>(contact?.priority || 'secondary');
    ...
    <Screen>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={{ marginTop: Spacing.xl }}>
          <PrimaryButton title="Update Contact" onPress={handleSave} />
        </View>
      </ScrollView>
    </Screen>
  );
